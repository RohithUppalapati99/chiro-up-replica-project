        ...
        <div className="relative overflow-hidden">
          <div className="flex space-x-6 animate-infinite-scroll">
            ...
            {reviews.map((review, index) => (
              <Card 
                key={index} 
                className="min-w-[280px] flex-shrink-0 bg-gradient-to-br from-background to-primary/5 border-primary/20 hover:border-primary/40 transition-all duration-500 hover:scale-105 hover:shadow-xl group"
              >
